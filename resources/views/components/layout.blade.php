...
<body>
    ...
    <nav class="w-full mx-auto flex flex-col items-center xl:w-3/4 xl:mx-auto xl:flex xl:flex-col xl:items-center ">
        ...
        <section class="w-full dropshadow flex justify-center h-42 lg:h-24 bg-background rounded-b-lg"> 
            <div class="lg:flex space-x-3 lg:space-x-6 items-center grid grid-rows-3 lg:grid-cols-3 w-11/12 lg:gap-x-52 justify-center lg:mx-auto">
                {{--  Col 1 --}}
