    ...
    <nav class="w-3/4 mx-auto flex flex-col items-center">
        ...
        <section class="w-full dropshadow flex justify-center h-20 bg-background rounded-b-lg">
            <div class="flex space-x-6 mr-6 items-center grid grid-cols-3 w-11/12 gap-x-52">
                ...
                <div class="w-full flex justify-evenly space-x-2">
                    <a href="/services/manage"
                        class="text-center text-lg h-8 w-24 text-black hover:text-white rounded-lg bg-buttons hover:bg-onhover">Services</a>
        ...
        <section class="flex w-2/3 h-14 justify-center bg-background rounded-b-lg dropshadowCat">
            <ul class="flex space-x-2 mr-6 h-11 w-11/12 justify-center text-base text-center align-middle">
                <li class="bg-buttons hover:bg-onhover w-1/6 p-1 pt-2 rounded-b-md"><a href="/?category_id=1">3D
                        Modelling</a></li>
                <li class="bg-buttons hover:bg-onhover w-1/6 p-1 pt-2 rounded-b-md"><a href="/?category_id=2">2D
                        Illustration</a></li>
                <li class="bg-buttons hover:bg-onhover w-1/6 p-1 pt-2 rounded-b-md"><a
                        href="/?category_id=3">Painting</a></li>
                <li class="bg-buttons hover:bg-onhover w-1/6 p-1 pt-2 rounded-b-md"><a href="/?category_id=4">SFX</a>
                </li>
                <li class="bg-buttons hover:bg-onhover w-1/6 p-1 pt-2 rounded-b-md"><a href="/?category_id=5">Wood
                        Sculpting</a></li>
                <li class="bg-buttons hover:bg-onhover w-1/6 p-1 pt-2 rounded-b-md"><a href="/?category_id=6">Logo
                        Design</a></li>
            </ul>
        </section>
    </nav>
